...
class Constancias extends Controller
{
    ...
    public function TallerPorIdProducto($id_producto) {
        ...
        View::set('modal',$modal);    
        View::set('tabla', $this->getAllUsuariosTaller($id_producto));
        View::set('asideMenu',$this->_contenedor->asideMenu());    
        View::render("constancias_all");
    }
...
html;
    ...
    public function abrirConstancia($id_registrado, $id_producto = null)
    {
        ...
        $insert_impresion_constancia = AsistentesDao::insertImpresionConstancia($datos_user['id_registrado'],'Fisica',$id_producto);
