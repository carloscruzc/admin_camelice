            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Comprobantes de Vacunacion</li>
                    </ol>
                </nav>
                    ...
                    <div class="row gx-4">
                        <div class="col-auto">
                            <div class="bg-gradient-musa avatar avatar-xl position-relative">
                                ...
                                <span class="fa fa-shield-virus" style="font-size: xx-large;"></span>
                            </div>
                        </div>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade position-relative height-350 border-radius-lg" id="vip" role="tabpanel" aria-labelledby="cam2">
                        <div class="row mt-4">
                            <div class="card mb-4">
                                <div class="card-header pb-0">
                                    <h6>Comprobantes Cargados con Exito - Que Fueron Rechazados por un Ejecutivo</h6>
                                </div>
                                <div class="card-body px-0 pt-0 pb-2">
                                    <div class="table-responsive p-0">
                                        <table id="table_rechazado" class="table align-items-center mb-0 table_rechazado">
                                            <thead>
                                                <tr>
                                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Status</th>
