<?php echo $header; ?>
<title>
    Pruebas Covid en Sitio - CAMELICE - GRUPO LAHE
</title>
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Pruebas Covid En Sitio</li>
                    </ol>
                </nav>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-auto">
                    <div class="bg-gradient-musa avatar avatar-xl position-relative">
                        ...
                        <span class="fa fa-utensils" style="font-size: xx-large;"></span>
                    </div>
                </div>
                <div class="col-sm-auto col-8">
                    <div class="h-100">
                        <h5 class="mb-1 font-weight-bolder col-sm-auto col-8">
                            Pruebas Covid en Sitio
                        </h5>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="Modal_AddLabel">Agregar Prueba</h5>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 col-12" >
                                ...
                                <div class="input-group">
                                    <!-- <input id="nombre" name="nombre" maxlength="29" pattern="[a-zA-Z ÑñáÁéÉíÍóÚ]*{2,254}" class="form-control" type="text" placeholder="Le Bon Vine" required="" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $detalles_registro['nombre'] ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"> -->
                                    <select name="asistente" id="asistente">
                                        <option selected disabled>Seleccione un Asistente</option>
                                        <?php echo $asistente;?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6 col-12" >
                                ...
                                <div class="input-group">
                                    <input id="fecha_prueba" name="fecha_prueba" min="2022-04-07" maxlength="29" class="form-control" type="date" placeholder="+52 55 1234 5678" required="" onfocus="focused(this)" onfocusout="defocused(this)" value="" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                </div>
                            </div>
                            <div class="col-md-6 col-12" >
                            ...
                            <div class="col-md-12 col-12" >
                                ...
                                <div class="input-group">
                                    <textarea id="nota" name="nota" class="form-control" type="text" placeholder="Esta prueba fue ..." required="" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $detalles_registro['codigo_vestimenta'] ?>" ></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    function borrarPruebaCovid(dato){
        $.ajax({
            url: "/PruebasCovidEnSitio/borrarPruebaCovid/"+dato,
            type: "POST",
            dataType: 'json',
            beforeSend: function() {
    ...
    $(document).ready(function() {
        ...
        $('#pruebas_sitio a').addClass('active');
        $('#pruebas_sitio .fa-virus').addClass('text-white');
        ...
        $('.editar_prueba').on("submit", function(event) {
            ...
            $.ajax({
                url: "/PruebasCovidEnSitio/Actualizar",
                type: "POST",
                data: formData,
                beforeSend: function() {
                    console.log("Procesando....");
                ...
                success: function(respuesta) {
                    ...
                    if (respuesta == 'success') {
                        Swal.fire("¡Se ha actualizado correctamente la Prueba!", "", "success").
                        then((value) => {
                            window.location.reload();
                        });
                    } else {
                        swal("¡No se pudo actualizar correctamente la Prueba!", "", "warning").
                        then((value) => {
